...
### 13. Practical: [Image Identifier App- WasmEdge](https://github.com/aryankaushik-git/outreachy/tree/main/aryankaushik/imgpro_wasm)
### 14. Blog: [Image Identifier App using Tensorflow | WasmEdge | Dapr | Docker](wasm.builders)
